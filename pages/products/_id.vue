      ...
      <div class="itemPage">
        <div class="left">
          ...
          <p>
            ...
            трикотажа экстра-пенье без начеса, для которого отобрали самые
            длинные и прочные волокна австралийского хлопка. Материал отлично
            регулирует температуру тела, мало мнется и долго служит. Произведено
            в России.
          </p>
        </div>
        <div class="right">
          ...
          <div class="buttons">
            <div class="flex gap10">
              <ButtonCart
                @highlightedSizeListener="highlightedSizeMethod"
                @highlightedColorListener="highlightedColorMethod"
          ...
          <div class="info">
            ...
            <div class="jcsb">
              <p style="line-height: 29px; width: 330px">
                ...
                Параметры модели: 176 | 90 | 61 | 90
              </p>
              <i
                :class="{ downActive: checkOpenedModel }"
                @click="checkedOpenedMethod"
                class="down"
              ></i>
            </div>
            ...
            <div class="jcsb">
              ...
              <i
                :class="{ downActive: checkedOpenedRecomendations }"
                @click="checkedOpenedMethodRecomendations"
                class="down"
              ></i>
            </div>
