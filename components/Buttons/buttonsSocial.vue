<template>
    <div class="buttons_help">
        <a href="https://t.me/whodatandrey" target="_blank" :class="{button_footer: footer === 'footer'}" class="telegram" ></a>
        <a href="https://vk.com/" target="_blank" :class="{button_footer: footer === 'footer'}" class="vk"></a>
    </div>
</template>
